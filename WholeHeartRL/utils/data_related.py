...
def get_data_paths():
    return PathHolder(
        dataset_folder=os.environ.get("DATA_ROOT", "./data/raw"),
        all_feature_tabular_dir=os.environ.get("ALL_FEATURE_TABULAR_DIR", "./data/tabular/all_features.csv"),
        biomarker_tabular_dir=os.environ.get("BIOMARKER_TABULAR_DIR", "./data/tabular/biomarkers.csv"),
        processed_folder=os.environ.get("PROCESS_ROOT", "./data/processed"),
        log_folder=os.environ.get("LOG_FOLDER", "./logs"),
        dataloader_file_folder=os.environ.get("DATALOADER_FILE_ROOT", "./data/dataloader"),
        cmr_path_pickle_name=os.environ.get("CMR_PATH_PICKLE_NAME", "cmr_subject_paths.pkl"),
        biomarker_table_pickle_name=os.environ.get("BIOMARKER_PICKLE_NAME", "biomarker_table.pkl"),
        processed_table_pickle_name=os.environ.get("PROCESSED_PICKLE_NAME", "processed_table.pkl"),
